                  ...
                  ?.map((product: Product) => (
                    <tr key={product?._id} className="border-b">
                      <td className="px-2 py-4 flex items-center gap-2">
                        <X
                          className="hover:text-red-600 hover:cursor-pointer hoverEffect min-w-5"
                          onClick={() => {
                        ...
                        {product?.images && (
                          <Link
                            ...
                            className="border rounded-md group hidden md:inline-flex md:min-w-20"
                          >
                            <Image
                              ...
                              width={80}
                              height={80}
                              className="rounded-md group-hover:scale-105 hoverEffect h-20 w-20 object-contain md:min-w-20"
                            />
                          </Link>
                        )}
                        <p className="line-clamp-1 font-semibold text-xs">
                          {product?.name}
                        </p>
                      </td>
                      ...
                      <td className="p-2 capitalize font-medium text-xs hidden md:table-cell">
                        {product?.variant}
                      </td>
                      <td
                        className={`p-2 w-24 font-medium text-xs ${
